        ...
        <AnimatePresence initial={false}>
          ...
          {shouldShowActiveAi && (
            ...
            >
              <InterviewMessageBubble
                ...
                suffix={(
                  <motion.span
                    className="inline-block w-1.5 h-1.5 bg-primary-container ml-1.5 rounded-full"
          ...
          {messages.length === 0 && !userText && !aiText && (
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="h-full flex flex-col items-center justify-center text-on-surface-variant py-12"
            >
              <div className="w-12 h-12 rounded-full bg-surface-container-lowest flex items-center justify-center mb-4 border border-outline-variant">
